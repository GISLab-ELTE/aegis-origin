...
namespace ELTE.AEGIS.IO.Storage.Operation
{
    ...
    public class HadoopCreateDirectoryOperation : HadoopFileSystemOperation
    {
        ...
        public HadoopCreateDirectoryOperation(HttpClient client) : base(client) { }
        ...
        /// </exception>
        /// <exception cref="System.ArgumentException">The path is empty.</exception>
        public HadoopCreateDirectoryOperation(HttpClient client, String path, IHadoopFileSystemAuthentication authentication) : base(client, path, authentication) { }
