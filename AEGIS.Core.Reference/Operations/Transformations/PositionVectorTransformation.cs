...
namespace ELTE.AEGIS.Reference.Operations
{
    ...
    /// </summary>
    [CoordinateOperationMethodImplementationAttribute("EPSG::1033", "Position Vector transformation (geocentric domain)")]
    public class PositionVectorTransformation : HelmertTransformation
    {
        ...
        /// </exception>
        public PositionVectorTransformation(String identifier, String name, IDictionary<CoordinateOperationParameter, Object> parameters)
            : base(identifier, name, CoordinateOperationMethods.PositionVectorTransformation, parameters)
        {
            // source: EPSG Guidance Note number 7, part 2, page 123

            Double det = 1 + Calculator.Square(_xAxisRotation) + Calculator.Square(_xAxisRotation) + Calculator.Square(_zAxisTranslation);
