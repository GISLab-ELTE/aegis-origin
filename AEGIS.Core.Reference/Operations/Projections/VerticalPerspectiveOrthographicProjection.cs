...
namespace ELTE.AEGIS.Reference.Operations
{
    ...
    [CoordinateOperationMethodImplementationAttribute("EPSG::9839", "Vertical Perspective (Orthographic case)")]
    public class VerticalPerspectiveOrthographicProjection : CoordinateProjection
    {
        ...
        /// </exception>
        public VerticalPerspectiveOrthographicProjection(IDictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid)
            : base(CoordinateOperationMethods.VerticalPerspectiveOrthographicProjection.Identifier, CoordinateOperationMethods.VerticalPerspectiveOrthographicProjection.Name, CoordinateOperationMethods.VerticalPerspectiveOrthographicProjection, parameters, ellipsoid, AreasOfUse.World)
        {
