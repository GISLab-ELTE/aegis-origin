...
namespace ELTE.AEGIS.Reference.Operations
{
    ...
    /// </summary>
    [CoordinateOperationMethodImplementationAttribute("AEGIS::1027", "Lambert Azimuthal Equal Area (Spherical) Projection")]
    public class LambertAzimuthalEqualAreaSphericalProjection : LambertAzimuthalEqualAreaProjection
    {
        ...
        /// </exception>
        public LambertAzimuthalEqualAreaSphericalProjection(String identifier, String name, Dictionary<CoordinateOperationParameter, Object> parameters, Ellipsoid ellipsoid, AreaOfUse areaOfUse)
            : base(identifier, name, CoordinateOperationMethods.LambertAzimuthalEqualAreaSphericalProjection, parameters, ellipsoid, areaOfUse)
        {
