...
namespace ELTE.AEGIS.Reference.Operations
{
    ...
    /// </summary>
    [CoordinateOperationMethodImplementationAttribute("EPSG::1026", "Mercator (Spherical)")]
    public class MercatorSphericalProjection : MercatorProjection
    {
        ...
        /// </exception>
        public MercatorSphericalProjection(String identifier, String name, Ellipsoid ellipsoid, Dictionary<CoordinateOperationParameter, Object> parameters, AreaOfUse areaOfUse)
            : base(identifier, name, CoordinateOperationMethods.MercatorSphericalProjection, parameters, ellipsoid, areaOfUse)
        {
            ...
            // source: EPSG Guidance Note number 7, part 2, page 37
