// <copyright file="ProjectionTransformation.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents a transformation between projected coordinate reference systems.
    /// </summary>
    public abstract class ProjectionTransformation : CoordinateTransformation<Coordinate>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectionTransformation" /> class.
        /// </summary>
        ...
        /// </exception>
        protected ProjectionTransformation(String identifier, String name, CoordinateOperationMethod method, IDictionary<CoordinateOperationParameter, Object> parameters, CoordinateReferenceSystem source, CoordinateReferenceSystem target, AreaOfUse areaOfUse)
