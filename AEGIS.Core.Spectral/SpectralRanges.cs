...
namespace ELTE.AEGIS
{
    ...
    public static class SpectralRanges
    {
        ...
        private static SpectralRange _soil;
        private static SpectralRange _vegetation;
        private static SpectralRange _water;
        ...
        public static SpectralRange NearInfrared
        {
            get
            {
                return _nearInfrared ?? (_nearInfrared = new SpectralRange(75e-8, 3e-6));
            }
        }
        ...
        public static SpectralRange Infrared
        {
            get
            {
                return _infrared ?? (_infrared = new SpectralRange(75e-6, 1000e-6));
            }
        }
        ...
        /// Soil.
        /// </summary>
        public static SpectralRange Soil
        {
            get
            {
                return _soil ?? (_soil = new SpectralRange(Double.MinValue, Double.MaxValue));
            }
        }
        ...
        /// Vegetation.
        /// </summary>
        public static SpectralRange Vegetation
        {
            get
            {
                return _vegetation ?? (_vegetation = new SpectralRange(Double.MinValue, Double.MaxValue));
            }
        }
        ...
        /// Water.
        /// </summary>
        public static SpectralRange Water
        {
            get
            {
                return _water ?? (_water = new SpectralRange(Double.MinValue, Double.MaxValue));
            }
        }
        ...
        /// RGB.
        /// </summary>
        public static SpectralRange[] RGB 
        {
            get
            {
                return new SpectralRange[] { Red, Green, Blue };
            }
        }
