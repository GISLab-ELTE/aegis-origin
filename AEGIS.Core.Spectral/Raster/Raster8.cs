...
namespace ELTE.AEGIS.Raster
{
    ...
    public class Raster8 : Raster
    {
        ...
        /// </exception>
        public Raster8(IRasterFactory factory, Int32 spectralResolution, Int32 numberOfRows, Int32 numberOfColumns, IList<Int32> radiometricResolutions, IList<SpectralRange> spectralRanges, RasterMapper mapper)
            : base(factory, spectralResolution, numberOfRows, numberOfColumns, radiometricResolutions, spectralRanges, mapper)
        {
            ...
            _values = Enumerable.Repeat<Byte[]>(null, spectralResolution).ToArray();
        ...
        /// </exception>
        public Raster8(IRasterFactory factory, IList<Byte[]> spectralValues, Int32 numberOfRows, Int32 numberOfColumns, IList<Int32> radiometricResolutions, IList<SpectralRange> spectralRanges, RasterMapper mapper)
        ...
        public override void SetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex, UInt32 spectralValue)
        {
            ...
            if (_values[bandIndex] == null)
            {
                ...
                _values[bandIndex] = new Byte[_numberOfRows * _numberOfColumns];
            }

            _values[bandIndex][rowIndex * _numberOfColumns + columnIndex] = (Byte)spectralValue;
        }
        ...
        public override void SetValues(Int32 rowIndex, Int32 columnIndex, UInt32[] spectralValues)
        {
            ...
            for (Int32 k = 0; k < spectralValues.Length; k++)
            {
                ...
                if (_values[k] == null)
                {
                    ...
                    _values[k] = new Byte[_numberOfRows * _numberOfColumns];
                }

                _values[k][rowIndex * _numberOfColumns + columnIndex] = (Byte)spectralValues[k];
            }
        }
        ...
        public override UInt32[] GetValues(Int32 rowIndex, Int32 columnIndex)
        {
            ...
            {
                values[k] = (_values[k] == null) ? (Byte)0 : _values[k][rowIndex * _numberOfColumns + columnIndex];
            }
            return values;
        }
        ...
        public override UInt32 GetNearestValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            ...
            return (_values[bandIndex] == null) ? (Byte)0 : _values[bandIndex][trueRowIndex * _numberOfColumns + trueColumnIndex];
        }
        ...
        {
            return new Raster8(_factory, _values, _numberOfRows, _numberOfColumns, _radiometricResolutions, _spectralRanges, _mapper);
        }
