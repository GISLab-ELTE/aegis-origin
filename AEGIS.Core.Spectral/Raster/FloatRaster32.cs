/// <copyright file="FloatRaster32.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Raster
{
    ...
    /// </summary>
    public class FloatRaster32 : FloatRaster
    {
        ...
        /// </exception>
        public FloatRaster32(IRasterFactory factory, Int32 spectralResolution, Int32 numberOfRows, Int32 numberOfColumns, IList<Int32> radiometricResolutions, IList<SpectralRange> spectralRanges, RasterMapper mapper)
            : base(factory, spectralResolution, numberOfRows, numberOfColumns, radiometricResolutions, spectralRanges, mapper)
        {
            ...
            _values = Enumerable.Repeat<Single[]>(null, spectralResolution).ToArray();
    ...
    /// <summary>
        ...
        /// </exception>
        public FloatRaster32(IRasterFactory factory, IList<Single[]> spectralValues, Int32 numberOfRows, Int32 numberOfColumns, IList<Int32> radiometricResolutions, IList<SpectralRange> spectralRanges, RasterMapper mapper)
        ...
        public override void SetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex, Double spectralValue)
        {
            ...
            if (_values[bandIndex] == null)
            {
                ...
                _values[bandIndex] = new Single[_numberOfRows * _numberOfColumns];
            }

            _values[bandIndex][rowIndex * _numberOfColumns + columnIndex] = (Single)spectralValue;
        }
        ...
        public override void SetValues(Int32 rowIndex, Int32 columnIndex, Double[] spectralValues)
        {
            ...
            for (Int32 k = 0; k < spectralValues.Length; k++)
            {
                ...
                if (_values[k] == null)
                {
                    ...
                    _values[k] = new Single[_numberOfRows * _numberOfColumns];
                }

                _values[k][rowIndex * _numberOfColumns + columnIndex] = (Single)spectralValues[k];
            }
        }
        ...
        public override Double[] GetValues(Int32 rowIndex, Int32 columnIndex)
        {
            ...
            {
                values[k] = (_values[k] == null) ? (Single)0 : _values[k][rowIndex * _numberOfColumns + columnIndex];
            }
            return values;
        }
        ...
        public override Double GetNearestValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            ...
            return (_values[bandIndex] == null) ? (Single)0 : _values[bandIndex][trueRowIndex * _numberOfColumns + trueColumnIndex];
        }
        ...
        {
            return new FloatRaster32(_factory, _values, _numberOfRows, _numberOfColumns, _radiometricResolutions, _spectralRanges, _mapper);
        }
