/// <copyright file="FloatRaster.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Provides a base class for multispectral raster images containing floating point values.
    /// </summary>
    public abstract class FloatRaster : IFloatRaster
    {
        ...
        protected readonly IFloatRasterBand[] _bands;
        ...
        public RasterRepresentation Representation { get { return RasterRepresentation.Floating; } }
        ...
        IList<IRasterBand> IRaster.Bands
        {
            get { return Array.AsReadOnly(_bands.Cast<IRasterBand>().ToArray()); }
        }
        ...
        /// </exception>
        IRasterBand IRaster.this[Int32 index]
        {
            get { return GetBand(index); }
        }
        ...
        /// </exception>
        UInt32 IRaster.this[Int32 rowIndex, Int32 columnIndex, Int32 bandIndex]
        {
            get { return (UInt32)GetValue(rowIndex, columnIndex, bandIndex); }
            set { SetValue(rowIndex, columnIndex, bandIndex, (UInt32)value); }
        }
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>      
        UInt32 IRaster.this[Coordinate coordinate, Int32 bandIndex]
        {
            get { return (UInt32)GetValue(coordinate, bandIndex); }
            set { SetValue(coordinate, bandIndex, (UInt32)value); }
        }
        /// <summary>
        ...
        /// the column index is equal to or greater than the number of columns.
        /// </exception>
        UInt32[] IRaster.this[Int32 rowIndex, Int32 columnIndex]
        {
            get { return GetValues(rowIndex, columnIndex).Cast<UInt32>().ToArray(); }
            set
            {
                if (value == null)
                    throw new ArgumentNullException("value", "The spectral values are not specified.");

                SetValues(rowIndex, columnIndex, value.Cast<Double>().ToArray());
            }
        }
        /// <summary>
        ...
        UInt32[] IRaster.this[Coordinate coordinate]
        {
            get { return GetValues(coordinate).Cast<UInt32>().ToArray(); }
            set
            {
                if (value == null)
                    throw new ArgumentNullException("value", "The spectral values are not specified.");

                SetValues(coordinate, value.Cast<Double>().ToArray());
            }
        }

        #endregion

        #region IFloatRaster properties

        /// <summary>
        /// Gets the spectral bands of the raster.
        /// </summary>
        /// <value>The read-only list containing the spectral bands in the raster.</value>
        public IList<IFloatRasterBand> Bands { get { return Array.AsReadOnly(_bands); } }
        ...
        /// The index is equal to or greater than the spectral resolution of the raster.
        /// </exception>
        public IFloatRasterBand this[Int32 index] { get { return GetBand(index); } }
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>        
        public Double this[Int32 rowIndex, Int32 columnIndex, Int32 bandIndex]
        {
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>        
        public Double this[Coordinate coordinate, Int32 bandIndex]
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ELTE.AEGIS.Raster.FloatRaster" /> class.
        /// </summary>
        /// <param name="maxRadiometricResolution">The maximum radiometric resolution.</param>
        /// <param name="mapper">The mapper.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">The maximum radiometric resolution is less than 1.;maxRadiometricResolution</exception>
        protected FloatRaster(IRasterFactory factory, Int32 spectralResolution, Int32 numberOfRows, Int32 numberOfColumns, IList<Int32> radiometricResolutions, IList<SpectralRange> spectralRanges, RasterMapper mapper)
        {
            ...
            _bands = Enumerable.Range(0, spectralResolution).Select(index => new FloatRasterBand(this, index)).ToArray<IFloatRasterBand>();
        ...
        /// The index is equal to or greater than the spectral resolution of the raster.
        /// </exception>
        IRasterBand IRaster.GetBand(Int32 index)
        {
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        void IRaster.SetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex, UInt32 spectralValue)
        {
            SetValue(rowIndex, columnIndex, bandIndex, (Double)spectralValue);
        }
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        void IRaster.SetValue(Coordinate coordinate, Int32 bandIndex, UInt32 spectralValue)
        {
            SetValue(coordinate, bandIndex, (Double)spectralValue);
        }
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        void IRaster.SetValues(Int32 rowIndex, Int32 columnIndex, UInt32[] spectralValues)
        {
            if (spectralValues == null)
                throw new ArgumentNullException("spectralValues", "The spectral values are not specified.");

            SetValues(rowIndex, columnIndex, spectralValues.Cast<Double>().ToArray());
        }
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">The coordinate is not within the raster.</exception>
        void IRaster.SetValues(Coordinate coordinate, UInt32[] spectralValues)
        {
            if (spectralValues == null)
                throw new ArgumentNullException("spectralValues", "The spectral values are not specified.");

            SetValues(coordinate, spectralValues.Cast<Double>().ToArray());
        }
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        UInt32 IRaster.GetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            return (UInt32)GetValue(rowIndex, columnIndex, bandIndex);
        }
        ...
        /// The coordinate is not within the raster.
        /// </exception>
        UInt32 IRaster.GetValue(Coordinate coordinate, Int32 bandIndex)
        {
            return (UInt32)GetValue(coordinate, bandIndex);
        }
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        UInt32[] IRaster.GetValues(Int32 rowIndex, Int32 columnIndex)
        {
            return GetValues(rowIndex, columnIndex).Cast<UInt32>().ToArray();
        }
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">The coordinate is not within the raster.</exception>
        UInt32[] IRaster.GetValues(Coordinate coordinate)
        {
            return GetValues(coordinate).Cast<UInt32>().ToArray();
        }
        ...
        UInt32 IRaster.GetNearestValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            return (UInt32)GetNearestValue(rowIndex, columnIndex, bandIndex);
        }
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        UInt32 IRaster.GetNearestValue(Coordinate coordinate, Int32 bandIndex)
        {
            return (UInt32)GetNearestValue(coordinate, bandIndex);
        }
        ...
        UInt32[] IRaster.GetNearestValues(Int32 rowIndex, Int32 columnIndex)
        {
            return GetNearestValues(rowIndex, columnIndex).Cast<UInt32>().ToArray();
        }
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        UInt32[] IRaster.GetNearestValues(Coordinate coordinate)
        {
            return GetNearestValues(coordinate).Cast<UInt32>().ToArray();
        }
        ...
        /// The index is equal to or greater than the spectral resolution of the raster.
        /// </exception>
        public IFloatRasterBand GetBand(Int32 index)
        {
            if (index < 0)
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        public abstract void SetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex, Double spectralValue);
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        public void SetValue(Coordinate coordinate, Int32 bandIndex, Double spectralValue)
        {
            if (_mapper == null)
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        public abstract void SetValues(Int32 rowIndex, Int32 columnIndex, Double[] spectralValues);
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">The coordinate is not within the raster.</exception>
        public void SetValues(Coordinate coordinate, Double[] spectralValues)
        {
            if (_mapper == null)
                throw new NotSupportedException("The mapping of the raster is not defined.");
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        public abstract Double GetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex);
        ...
        /// The coordinate is not within the raster.
        /// </exception>
        public Double GetValue(Coordinate coordinate, Int32 bandIndex)
        {
            if (_mapper == null)
                throw new NotSupportedException("The mapping of the raster is not defined.");
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        public abstract Double[] GetValues(Int32 rowIndex, Int32 columnIndex);
        ...
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">The coordinate is not within the raster.</exception>
        public Double[] GetValues(Coordinate coordinate)
        {
            if (_mapper == null)
                throw new NotSupportedException("The mapping of the raster is not defined.");
        ...
        /// <param name="bandIndex">The zero-based band index of the value.</param>
        /// <returns>The spectral values for the band at the specified index or the nearest index if either row or column is out of range.</returns>
        public abstract Double GetNearestValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex);
        ...
        /// <returns>Returns the nearest spectral value in a band at the specified coordinate or at the nearest coordinate if the coordinate is out of range.</returns>
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        public Double GetNearestValue(Coordinate coordinate, Int32 bandIndex)
        {
            if (_mapper == null)
                throw new NotSupportedException("The mapping of the raster is not defined.");
        ...
        /// <param name="k">The zero-based row index of the values.</param>
        /// <returns>The array containing the spectral values for each band at the specified index or the nearest index if either row or column is out odf range.</returns>
        public abstract Double[] GetNearestValues(Int32 rowIndex, Int32 columnIndex);
        ...
        /// <returns>The array containing the spectral values for each band at the specified coordinate or at the nearest coordinate if the coordinate is out of range.</returns>
        /// <exception cref="System.NotSupportedException">The mapping of the raster is not defined.</exception>
        public Double[] GetNearestValues(Coordinate coordinate)
        {
            if (_mapper == null)
                throw new NotSupportedException("The mapping of the raster is not defined.");
        ...
        /// <summary>
        /// Creates a clone of the <see cref="T:ELTE.AEGIS.Raster.FloatRaster" /> instance.
        /// </summary>
        /// <returns>The deep copy of the <see cref="T:ELTE.AEGIS.Raster.FloatRaster" /> instance.</returns>
        ...
        {
            return "Raster [" + _numberOfRows + "x" + _numberOfColumns + "x" + SpectralResolution + "]";
        }
