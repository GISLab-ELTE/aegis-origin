/// <copyright file="ProxyFloatRaster.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents a raster image managing values in a entity containg floating point values.
    /// </summary>
    public class ProxyFloatRaster : IFloatRaster
    {
        ...
        private readonly IFloatRasterBand[] _bands;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyFloatRaster" /> class.
        /// </summary>
        ...
        /// </exception>
        public ProxyFloatRaster(IRasterFactory factory, ISpectralEntity entity, IList<SpectralRange> spectralRanges, RasterMapper mapper)
        {
            if (entity == null)
                throw new ArgumentNullException("entity", "The entity is null.");

            if (entity.Representation != RasterRepresentation.Floating)
            ...
            _bands = Enumerable.Range(0, _spectralResolution).Select(index => new FloatRasterBand(this, index)).ToArray<IFloatRasterBand>();
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        public void SetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex, Double spectralValue)
        {
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        public void SetValues(Int32 rowIndex, Int32 columnIndex, Double[] spectralValues)
        {
            if (spectralValues == null)
                throw new ArgumentNullException("spectralValues", "The spectral values are not specified.");
        ...
        /// The band index is equal to or greater than the number of bands.
        /// </exception>
        public Double GetValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            return _entity.ReadFloatValue(rowIndex, columnIndex, bandIndex);
        }
        ...
        /// The column index is equal to or greater than the number of columns.
        /// </exception>
        public Double[] GetValues(Int32 rowIndex, Int32 columnIndex)
        {
            if (_isSequentialDataset)
                return _entity.ReadFloatValueSequence(rowIndex, columnIndex, 0, _spectralResolution);
            else
            {
                Double[] values = new Double[_spectralResolution];
                for (Int32 k = 0; k < _spectralResolution; k++)
                    values[k] = _entity.ReadFloatValue(rowIndex, columnIndex, k);
        ...
        /// <returns>The spectral values for the band at the specified index or the nearest index if either row or column is out of range.</returns>
        /// <exception cref="System.NotSupportedException">The raster is not readable.</exception>
        public Double GetNearestValue(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
        ...
        /// <returns>The array containing the spectral values for each band at the specified index or the nearest index if either row or column is out odf range.</returns>
        /// <exception cref="System.NotSupportedException">The raster is not readable.</exception>
        public Double[] GetNearestValues(Int32 rowIndex, Int32 columnIndex)
        {
            Int32 trueRowIndex = Math.Min(Math.Max(rowIndex, 0), _numberOfRows - 1);
            Int32 trueColumnIndex = Math.Min(Math.Max(columnIndex, 0), _numberOfColumns - 1);

            if (_isSequentialDataset)
                return _entity.ReadFloatValueSequence(trueRowIndex, trueColumnIndex, 0, _spectralResolution);
            else
            {
                Double[] values = new Double[_spectralResolution];
                for (Int32 k = 0; k < _spectralResolution; k++)
                    values[k] = _entity.ReadFloatValue(trueRowIndex, trueColumnIndex, k);
