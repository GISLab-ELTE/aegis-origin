...
namespace ELTE.AEGIS.Raster
{
    ...
    public class RasterFloat32 : Raster
    {
        ...
        public override RasterRepresentation Representation { get { return RasterRepresentation.Floating; } }
        ...
        protected override void ApplySetValues(Int32 rowIndex, Int32 columnIndex, UInt32[] spectralValues)
        {
            for (Int32 k = 0; k < spectralValues.Length; k++)
            {
                ...
                if (_values[k] == null)
                {
                    ...
                    _values[k] = new Single[NumberOfRows * NumberOfColumns];
                }

                _values[k][rowIndex * NumberOfColumns + columnIndex] = (Single)spectralValues[k];
            }
        }
