/// <copyright file="CustomFilterOperation.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents a filtering operation using custom kernel, factor and offset values.
    /// </summary>
    [OperationMethodImplementation("AEGIS::251100", "Custom filter")]
    public class CustomFilterOperation : GradientFilterOperation
    {
        #region Constructors
        ...
        /// </exception>
        public CustomFilterOperation(ISpectralGeometry source, IDictionary<OperationParameter, Object> parameters)
