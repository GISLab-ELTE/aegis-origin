/// <copyright file="SobelFilterOperation.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents a Sobel filter operation.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [OperationMethodImplementation("AEGIS::251182", "Sobel filter")]
    public class SobelFilterOperation : GradientFilterOperation
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="SobelFilterOperation" /> class.
        /// </summary>
        ...
        /// </exception>
        public SobelFilterOperation(ISpectralGeometry source, IDictionary<OperationParameter, Object> parameters)
        ...
        /// </exception>
        public SobelFilterOperation(ISpectralGeometry source, ISpectralGeometry target, IDictionary<OperationParameter, Object> parameters)
            : base(source, target, SpectralOperationMethods.SobelFilter, parameters)
        {
            AddFilter(FilterFactory.CreateSobelHorizontalFilter());
            AddFilter(FilterFactory.CreateSobelVerticalFilter());
        }
