/// <copyright file="SoilAdjustedVegetationIndexComputation.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents an operation computing the soil adjusted vegetation index (SAVI) of raster geometries.
    /// </summary>
    [OperationMethodImplementation("AEGIS::252033", "Soil adjusted vegetation (SAVI) index computation")]
    public class SoilAdjustedVegetationIndexComputation : SpectralTransformation
    {
        ...
        /// </exception>
        public SoilAdjustedVegetationIndexComputation(ISpectralGeometry source, IDictionary<OperationParameter, Object> parameters)
        ...
        protected override Double ComputeFloat(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            ...
            return (nir + red + 0.5 == 0) ? 0 : ((nir - red) * 1.5) / (nir + red + 0.5);
