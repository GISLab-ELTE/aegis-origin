    ...
    public class EnhancedVegetationIndexComputation : SpectralTransformation
    {
            ...
            : base(source, result, SpectralOperationMethods.EnhancedVegetationIndexComputation, parameters)
        {
            try
            {
                ...
                _indexOfBlueBand = Convert.ToInt32(ResolveParameter(SpectralOperationParameters.IndexOfBlueBand, _source.Imaging.SpectralDomains.IndexOf(SpectralDomain.Blue)));
            }
            catch
            {
