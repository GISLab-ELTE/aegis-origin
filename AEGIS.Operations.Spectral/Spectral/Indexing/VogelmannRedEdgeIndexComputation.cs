    ...
    public class VogelmannRedEdgeIndexComputation : SpectralTransformation
    {
            ...
            : base(source, result, SpectralOperationMethods.VogelmannRedEdgeIndexComputation, parameters)
        {
            try
            {
                ...
                _indexOf726nmBand = Convert.ToInt32(ResolveParameter(SpectralOperationParameters.IndexOf726nmBand, _source.Imaging.SpectralRanges.FindIndex(range => range.WavelengthMinimum <= 726e-9 && range.WavelengthMaximum >= 726e-9)));
                ...
                _indexOf740nmBand = Convert.ToInt32(ResolveParameter(SpectralOperationParameters.IndexOf740nmBand, _source.Imaging.SpectralRanges.FindIndex(range => range.WavelengthMinimum <= 740e-9 && range.WavelengthMaximum >= 740e-9)));
