/// <copyright file="NormalizedDifferenceInfraredIndexComputation.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents an operation computing the normalized difference infrared index (NDII) of raster geometries.
    /// </summary>
    [OperationMethodImplementation("AEGIS::252015", "Normalized difference infrared index (NDII) computation")]
    public class NormalizedDifferenceInfraredIndexComputation : SpectralTransformation
    {
        ...
        /// <summary>
        /// The index of the 1649nm band.
        /// </summary>
        private readonly Int32 _indexOf1649nmBand;
        ...
        /// </exception>
        public NormalizedDifferenceInfraredIndexComputation(ISpectralGeometry source, IDictionary<OperationParameter, Object> parameters)
            ...
            : base(source, result, SpectralOperationMethods.NormalizedDifferenceInfraredIndexComputation, parameters)
        {
            try
            {
                _indexOf819nmBand = Convert.ToInt32(ResolveParameter(SpectralOperationParameters.IndexOf819nmBand, _source.Imaging.SpectralRanges.FindIndex(range => range.WavelengthMinimum <= 819e-9 && range.WavelengthMaximum >= 819e-9)));
                _indexOf1649nmBand = Convert.ToInt32(ResolveParameter(SpectralOperationParameters.IndexOf1649nmBand, _source.Imaging.SpectralRanges.FindIndex(range => range.WavelengthMinimum <= 1649e-9 && range.WavelengthMaximum >= 1649e-9)));
            }
            catch
            {
        ...
        protected override Double ComputeFloat(Int32 rowIndex, Int32 columnIndex, Int32 bandIndex)
        {
            ...
            switch (Source.Raster.Format)
            {
                case RasterFormat.Integer:
                    ...
                    nm1649 = Source.Raster.GetValue(rowIndex, columnIndex, _indexOf1649nmBand);
                    break;

                default:
                    nm819 = Source.Raster.GetFloatValue(rowIndex, columnIndex, _indexOf819nmBand);
                    nm1649 = Source.Raster.GetFloatValue(rowIndex, columnIndex, _indexOf1649nmBand);
                    break;
            }

            return (nm819 + nm1649 == 0) ? 0 : ((nm819 - nm1649) / (nm819 + nm1649));
        }
