/// <copyright file="KruskalsAlgorithmTest.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Test fixture for class <see cref="KruskalsAlgorithm" />.
    /// </summary>
    [TestFixture]
    public class KruskalsAlgorithmTest
    {
        ...
        public void SetUp()
        {
            ...
            // source: http://en.wikipedia.org/wiki/Kruskal%27s_algorithm
            ...
            _sourceGraph.AddEdge(vertex1, vertex4, CreateWeightMetadata(5));
            _sourceGraph.AddEdge(vertex2, vertex3, CreateWeightMetadata(8));
            _sourceGraph.AddEdge(vertex2, vertex4, CreateWeightMetadata(9));
            _sourceGraph.AddEdge(vertex2, vertex5, CreateWeightMetadata(7));
            ...
            _sourceGraph.AddEdge(vertex5, vertex6, CreateWeightMetadata(8));
            _sourceGraph.AddEdge(vertex6, vertex7, CreateWeightMetadata(11));
            _sourceGraph.AddEdge(vertex5, vertex7, CreateWeightMetadata(9));

            _sourceGraph.AddEdge(vertex2, vertex1, CreateWeightMetadata(7));
            _sourceGraph.AddEdge(vertex4, vertex1, CreateWeightMetadata(5));
            _sourceGraph.AddEdge(vertex3, vertex2, CreateWeightMetadata(8));
            _sourceGraph.AddEdge(vertex4, vertex2, CreateWeightMetadata(9));
            _sourceGraph.AddEdge(vertex5, vertex2, CreateWeightMetadata(7));
            ...
            _sourceGraph.AddEdge(vertex6, vertex5, CreateWeightMetadata(8));
            _sourceGraph.AddEdge(vertex7, vertex6, CreateWeightMetadata(11));
            _sourceGraph.AddEdge(vertex7, vertex5, CreateWeightMetadata(9));
            ...
            _resultGraph.AddEdge(vertex1, vertex4, CreateWeightMetadata(5));
            _resultGraph.AddEdge(vertex2, vertex5, CreateWeightMetadata(7));
            _resultGraph.AddEdge(vertex3, vertex5, CreateWeightMetadata(5));
            _resultGraph.AddEdge(vertex4, vertex6, CreateWeightMetadata(6));
            _resultGraph.AddEdge(vertex5, vertex7, CreateWeightMetadata(9));

            _resultGraph.AddEdge(vertex2, vertex1, CreateWeightMetadata(7));
            _resultGraph.AddEdge(vertex4, vertex1, CreateWeightMetadata(5));
            _resultGraph.AddEdge(vertex5, vertex2, CreateWeightMetadata(7));
            _resultGraph.AddEdge(vertex5, vertex3, CreateWeightMetadata(5));
            _resultGraph.AddEdge(vertex6, vertex4, CreateWeightMetadata(6));
            _resultGraph.AddEdge(vertex7, vertex5, CreateWeightMetadata(9));
        }
