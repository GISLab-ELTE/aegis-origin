...
namespace ELTE.AEGIS.IO
{
    ...
    public static class EndianBitConverter
    {
        ...
        /// <exception cref="System.ArgumentNullException">array;The array is null.</exception>
        /// <exception cref="System.ArgumentException">The number of bytes in the array is less than required.;array</exception>
        ...
        /// startIndex;The starting index is less than 0.
        /// or
        /// startIndex;The starting index is equal to or greater than the length of the array.
        /// </exception>
        /// <exception cref="System.ArgumentException">The number of bytes in the array is less than required.;array</exception>
