/// <copyright file="LasPointFormat9.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.IO.Lasfile
{
    ...
    /// <summary>
    /// Represents a LAS point format 9 geometry in Cartesian coordinate space.
    /// </summary>
    public class LasPointFormat9 : LasPointFormat6
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LasPointFormat9" /> class.
        /// </summary>
        /// <param name="x">The X coordinate.</param>
        /// <param name="y">The Y coordinate.</param>
        /// <param name="z">The Z coordinate.</param>
        public LasPointFormat9(Double x, Double y, Double z)
            : base(x, y, z)
        {
            Format = 9;
        }
