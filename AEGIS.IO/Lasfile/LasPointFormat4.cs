/// <copyright file="LasPointFormat4.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.IO.Lasfile
{
    ...
    /// <summary>
    /// Represents a LAS point format 4 geometry in Cartesian coordinate space.
    /// </summary>
    public class LasPointFormat4 : LasPointFormat1
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LasPointFormat4" /> class.
        /// </summary>
        /// <param name="x">The X coordinate.</param>
        /// <param name="y">The Y coordinate.</param>
        /// <param name="z">The Z coordinate.</param>
        public LasPointFormat4(Double x, Double y, Double z)
            : base(x, y, z)
        {
            Format = 4;
        }
