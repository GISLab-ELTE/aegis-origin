// <copyright file="MaximumHeightMapTest.cs" company="Eötvös Loránd University (ELTE)">
...
{
    [TestFixture]
    public class MaximumHeightMapTest
    {
        [Test]
        public void MaxHMTest1()
        {
            ...
            var method = new MaximumHeightMap(ref octree, header, 1, 1, 0.5);
        ...
        public void MaxHMTest2()
        {
            ...
            Assert.AreEqual(16, grid[0, 0]);
            Assert.AreEqual(11, grid[0, 1]);
            Assert.AreEqual(12, grid[1, 0]);
            Assert.AreEqual(14, grid[1, 1]);
        }
    }
}