/// <copyright file="CoorindateRing.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS
{
    ...
    public class CoordinateRing : IEnumerable<Coordinate>, IEquatable<CoordinateRing>
    {
        ...
        /// </summary>
        private readonly IList<Coordinate> _elements;

        /// <summary>
        /// Stores the index of the starting coorindate.
        /// </summary>
        ...
        public IList<Coordinate> Origin
        {
