...
namespace ELTE.AEGIS.Geometry
{
    ...
    public class Triangle : Polygon, ITriangle
    {
        ...
        /// </summary>
        /// <value><c>true</c> if if the coordinates form a legitimate triangle; otherwise, <c>false</c>.</value>
        ...
        {
            return new Triangle(_shell.Coordinates[0], _shell.Coordinates[1], _shell.Coordinates[2], _factory, Metadata);
        }
