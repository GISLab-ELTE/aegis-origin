...
namespace ELTE.AEGIS.Tests.Operations.Spectral.Classification
{
    ...
    public class ClassificationAccuracyValidationTest
    {
        ...
        public void SetUp()
        {
            ...
            _sourceRasterMock.Setup(raster => raster.GetValue(It.IsInRange(0, 1, Moq.Range.Inclusive), It.IsInRange(0, 3, Moq.Range.Inclusive), 0)).Returns(2);
            _sourceRasterMock.Setup(raster => raster.GetValue(It.IsInRange(2, 3, Moq.Range.Inclusive), It.IsInRange(0, 3, Moq.Range.Inclusive), 0)).Returns(5);
            ...
            _referenceRasterMock.Setup(raster => raster.GetValue(It.IsInRange(0, 1, Moq.Range.Inclusive), It.IsInRange(0, 3, Moq.Range.Inclusive), 0)).Returns(1);
            _referenceRasterMock.Setup(raster => raster.GetValue(It.IsInRange(2, 3, Moq.Range.Inclusive), It.IsInRange(0, 3, Moq.Range.Inclusive), 0)).Returns(5);
        }
