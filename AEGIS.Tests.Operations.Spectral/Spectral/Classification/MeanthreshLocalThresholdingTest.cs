/// <copyright file="MeanthreshLocalThresholdingClassificationTest.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Test fixture for the <see cref="MeanthreshLocalThresholdingClassification" /> class.
    /// </summary>
    [TestFixture]
    public class MeanthreshLocalThresholdingTest
    {
        ...
        /// </summary>
        [Test]
        public void MeanthreshLocalThresholdingClassificationExecuteTest()
        {
            IGeometryFactory factory = new GeometryFactory();

            MeanthreshLocalThresholdingClassification operation = new MeanthreshLocalThresholdingClassification(factory.CreateSpectralPolygon(_rasterMock.Object), null);
            operation.Execute();
