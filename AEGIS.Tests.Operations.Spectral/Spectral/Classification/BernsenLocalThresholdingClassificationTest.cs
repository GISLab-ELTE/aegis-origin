/// <copyright file="BernsenLocalThresholdingClassificationTest.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Test fixture for the <see cref="BernsenLocalThresholdingClassification" /> class.
    /// </summary>
    [TestFixture]
    public class BernsenLocalThresholdingClassificationTest
    {
        ...
        /// </summary>
        [Test]
        public void BernsenLocalThresholdingClassificationExecuteTest()
        {
            IGeometryFactory factory = new GeometryFactory();

            BernsenLocalThresholdingClassification operation = new BernsenLocalThresholdingClassification(factory.CreateSpectralPolygon(_rasterMock.Object), null);
            operation.Execute();
