...
namespace ELTE.AEGIS.Tests.Operations.Spectral.Common
{
    ...
    public class SpectralInversionTest
    {
        ...
        public void SpectralInversionExecuteTest()
        {
            ...
            // test case 1: integer raster with specified band

            IDictionary<OperationParameter, Object> parameters = new Dictionary<OperationParameter, Object>();
            parameters.Add(SpectralOperationParameters.BandIndex, 0);

            operation = new SpectralInversion(Factory.DefaultInstance<IGeometryFactory>().CreateSpectralPolygon(_raster.Object), parameters);
            operation.Execute();
