// <copyright file="LogarithmicTransformationTest.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Test fixture for the <see cref="LogarithmicTransformation" /> class.
    /// <author>Gábor Balázs Butkay</author>
    /// </summary>
    [TestFixture]
    public class LogarithmicTransformationTest
    {
        ...
        public void SetUp()
        {
            ...
            _rasterMock.Setup(raster => raster.RadiometricResolution).Returns(_radiometricResolution);
        ...
        /// </summary>
        [Test]
        public void LogarithmicTransformationExecuteTest()
        {
            IGeometryFactory factory = new GeometryFactory();

            LogarithmicTransformation operation = new LogarithmicTransformation(factory.CreateSpectralPolygon(_rasterMock.Object), null);
            operation.Execute();
            ...
            for (Int32 bandIndex = 0; bandIndex < result.Raster.NumberOfBands; bandIndex++)
                for (Int32 rowIndex = 0; rowIndex < result.Raster.NumberOfRows; rowIndex++)
                    ...
                    {
                        Assert.AreEqual((Single)Math.Log(_rasterMock.Object.GetFloatValue(rowIndex, columnIndex, bandIndex)), result.Raster.GetFloatValue(rowIndex, columnIndex, bandIndex));
                    }
        }
