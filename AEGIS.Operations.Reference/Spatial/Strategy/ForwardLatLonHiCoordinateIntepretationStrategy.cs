...
namespace ELTE.AEGIS.Operations.Spatial.Strategy
{
    ...
    /// </summary>
    public class ForwardLatLonHiCoordinateIntepretationStrategy : ITransformationStrategy<GeoCoordinate, Coordinate>
    {
        ...
        public ForwardLatLonHiCoordinateIntepretationStrategy(CoordinateReferenceSystem referenceSystem)
        {
            ...
            if (referenceSystem.CoordinateSystem.Dimension != 3)
            ...
            if (!referenceSystem.CoordinateSystem.GetAxis(0).Name.Equals("Geodetic longitude") ||
                ...
                !referenceSystem.CoordinateSystem.GetAxis(1).Name.Contains("height"))
                throw new ArgumentException("The coordinate system of the reference system does not match the conversion.", "referenceSystem");
        ...
        {
            return new Coordinate(coordinate.Latitude.GetValue(_latitudeUnit),
                                  coordinate.Longitude.GetValue(_longitudeUnit),
