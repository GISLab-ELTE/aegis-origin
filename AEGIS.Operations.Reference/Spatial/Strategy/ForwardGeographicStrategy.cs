/// <copyright file="ForwardGeographicStrategy.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Represents a forward geographic transformation strategy
    /// </summary>
    public class ForwardGeographicStrategy : ITransformationStrategy<GeoCoordinate, GeoCoordinate>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForwardGeographicStrategy" /> class.
        /// </summary>
        ...
        /// </exception>
        public ForwardGeographicStrategy(GeographicCoordinateReferenceSystem source, GeographicCoordinateReferenceSystem target, GeographicTransformation transformation)
        {
            if (source == null)
        ...
        {
            return _transformation.Forward(coordinate);
        }
