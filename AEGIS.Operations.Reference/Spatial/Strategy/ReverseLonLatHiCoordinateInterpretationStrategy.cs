...
namespace ELTE.AEGIS.Operations.Spatial.Strategy
{
    ...
    /// </summary>
    public class ReverseLonLatHiCoordinateInterpretationStrategy : ITransformationStrategy<Coordinate, GeoCoordinate>
    {
        ...
        {
            return new GeoCoordinate(new Angle(coordinate.Y, _latitudeUnit),
                                     new Angle(coordinate.X, _longitudeUnit), 
                                     new Length(coordinate.Z, _heightUnit));
