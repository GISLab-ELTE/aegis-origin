/// <copyright file="ReferenceTransformationCertificate.cs" company="Eötvös Loránd University (ELTE)">
...
namespace ELTE.AEGIS.Operations.Spatial
{
    ...
    /// </summary>
    public class ReferenceTransformationCertificate : OperationCertificate
    {
        /// <summary>
