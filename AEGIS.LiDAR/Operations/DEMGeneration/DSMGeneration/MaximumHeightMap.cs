// <copyright file="MaximumHeightMap.cs" company="Eötvös Loránd University (ELTE)">
...
{
    /// <summary>
    /// Implemetation of a DSM gerenration operation, where each cell's height will be determined based on the heighest point in that area.
    /// </summary>
    /// <author>Roland Krisztandl</author>
    public class MaximumHeightMap : DSMGenerationMethod
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        /// </param>
        public MaximumHeightMap(ref PointOctree<LasPointBase> octree, LasPublicHeader header, int threadCount, double cellSize, double radius)
